...
@section('content')
    <style type="text/css">
        .inputWithIcon [name="hourly_rate"] {
            padding-left: 30px;
        }
    </style>
                    ...
                    <div class="wt-dashboardbox wt-dashboardtabsholder">
                        ...
                        <div class="wt-tabscontent tab-content">
                            ...
                            <div class="wt-personalskillshold tab-pane active fade show" id="wt-skills">
                                {!! Form::open(['action' =>'FreelancerController@storeProfileSettings', 'method' => 'post', 'enctype' => 'multipart/form-data', 'class' => 'wt-userform', 'id' => 'freelancer_profile' , '@submit.prevent'=>'submitFreelancerProfile']) !!}
