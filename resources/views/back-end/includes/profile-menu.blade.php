            ...
            @if ($role === 'client' || $role === 'writer' )
                    ...
                    @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'jobs')
                        ...
                        <li class="menu-item-has-children page_item_has_children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{{ url('client/jobs/completed') }}}">{{ trans('lang.completed_projects') }}</a></li>
                                <li><a href="{{{ url('client/jobs/hired') }}}">{{ trans('lang.ongoing_projects') }}</a></li>
                            </ul>
                        </li>
                    @endif
                    @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services')
                ...
                @elseif ($role === 'writer')
                    <li class="menu-item-has-children page_item_has_children">
                        ...
                        <ul class="sub-menu">
                            <li><a href="{{{ url('writer/jobs/completed') }}}">{{ trans('lang.completed_projects') }}</a></li>
                            <li><a href="{{{ url('writer/jobs/cancelled') }}}">{{ trans('lang.cancelled_projects') }}</a></li>
                            <li><a href="{{{ url('writer/jobs/hired') }}}">{{ trans('lang.ongoing_projects') }}</a></li>
                        </ul>
                    </li>
                    @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services')
                        <li class="menu-item-has-children">
                    ...
                    @if ($payment_module === 'true' )
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                    <li><a href="{{{ url('writer/package/invoice') }}}">{{ trans('lang.pkg_inv') }}</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{{ url('dashboard/packages/'.$role) }}}">
