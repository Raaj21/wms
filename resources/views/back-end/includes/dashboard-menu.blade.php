                    ...
                    @if ($role === 'admin')
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><hr><a href="{{{ route('genre') }}}">{{ trans('lang.genre') }}</a></li>
                                <li><hr><a href="{{{ route('type') }}}">{{ trans('lang.type') }}</a></li>
                                <li><hr><a href="{{{ route('education') }}}">{{ trans('lang.education') }}</a></li>
                    ...
                    @if ($role === 'client' || $role === 'writer' )
                            ...
                            @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'jobs')
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><hr><a href="{{{ url('client/jobs/completed') }}}">{{ trans('lang.completed_jobs') }}</a></li>
                                        <li><hr><a href="{{{ url('client/jobs/hired') }}}">{{ trans('lang.ongoing_jobs') }}</a></li>
                                    </ul>
                                </li>
                            @endif
                            @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services')
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li><hr><a href="{{{ url('client/services/hired') }}}">{{ trans('lang.ongoing_services') }}</a></li>
                                        <li><hr><a href="{{{ url('client/services/completed') }}}">{{ trans('lang.completed_services') }}</a></li>
                                        <li><hr><a href="{{{ url('client/services/cancelled') }}}">{{ trans('lang.cancelled_services') }}</a></li>
                                    </ul>
                                </li>
                            @endif
                            <li>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    @if ($employer_payment_module === 'true' )
                                        <li><hr><a href="{{{ url('client/package/invoice') }}}">{{ trans('lang.pkg_inv') }}</a></li>
                                    @endif
                                    <li><hr><a href="{{{ url('client/project/invoice') }}}">{{ trans('lang.project_inv') }}</a></li>
                                </ul>
                            </li>
                            @if ($employer_payment_module === 'true' )
                                <li>
                        ...
                        @elseif ($role === 'writer')
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li><hr><a href="{{{ url('writer/jobs/completed') }}}">{{ trans('lang.completed_projects') }}</a></li>
                                    <li><hr><a href="{{{ url('writer/jobs/cancelled') }}}">{{ trans('lang.cancelled_projects') }}</a></li>
                                    <li><hr><a href="{{{ url('writer/jobs/hired') }}}">{{ trans('lang.ongoing_projects') }}</a></li>
                                </ul>
                            </li>
                            @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services')
                                <li class="menu-item-has-children">
                            ...
                            @if ($payment_module === 'true' )
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li><hr><a href="{{{ url('writer/package/invoice') }}}">{{ trans('lang.pkg_inv') }}</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{{ url('dashboard/packages/'.$role) }}}">
