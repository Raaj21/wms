                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 col-xl-4 float-left">
                        <aside id="wt-sidebar" class="wt-sidebar">
                            <div class="wt-widget">
                                ...
                                @if (isset($languages) && !empty($languages) && $languages->count() > 0)
                            ...
                            <div class="wt-widget">
                                ...
                                @if (isset($types) && !empty($types) && $types->count() > 0)
                                    <div class="wt-widgetcontent wt-skillscontent">
                                ...
                                @else
                                    <p>{{ trans('lang.no_types') }}</p>
                                @endif
                            </div>
                            <!--<div id="wt-ourskill" class="wt-widget d-none">
                                <div class="wt-widgettitle">
