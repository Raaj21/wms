                                        ...
                                        <div class="wt-packagecontent">
                                            <ul class="wt-packageinfo">
                                                ...
                                                @foreach ($options as $key => $option)
                                                    @php
                                                        $class = '';
                                                        if ($key == 'banner_option' || $key == 'private_chat' || $key == 'image_option' && $role->role_type !='writer') {
                                                            $class = $option == 'true' ? 'ti-check' : 'ti-na';
                                                        }
                                                    @endphp
                                                    @if ($key == 'banner_option' || $key == 'private_chat' || $key == 'image_option')
                                                    ...
                                                    @elseif ($key == 'jobs' && $role->role_type =='client')
                                                        <li><span> {{ $option }}</span></li>
                                                    @elseif ($key == 'no_of_connects' && $role->role_type !='client')
                                                        <li><span> {{ $option }}</span></li>
                                                    @elseif ($key == 'no_of_skills' && $role->role_type !='writer')
                                                        <li><span> {{ $option }}</span></li>
                                                    @elseif ($key == 'no_of_services' && $role->role_type !='writer')
                                                        <li><span> {{ $option }}</span></li>
                                                    @elseif ($key == 'no_of_featured_services' && $role->role_type !='writer')
                                                        <li><span> {{ $option }}</span></li>
                                                    @elseif ($role->role_type =='client')
                                                        <li><span> {{ $option }}</span></li>
                                                    @endif
                                                @endforeach
                                            </ul>
