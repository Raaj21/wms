                    ...
                    @if (!empty($languages))
                        <div class="wt-checkboxholder wt-verticalscrollbar">
                            @foreach ($languages as $language)
                                ...
                                $reqLanguages = $_GET['languages'] ?? [];

                                if(!empty($reqLanguages)) {
                                    $reqLanguages = array_map('strtolower', $reqLanguages);
                                }

                                $checked = (!empty($reqLanguages) && in_array(ucfirst($language->slug), $reqLanguages) ) ? 'checked' : '';
