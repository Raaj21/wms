                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->shipping_amount}}} {{ strtoupper($currency_code) }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->handling_amount}}} {{ strtoupper($currency_code) }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
                                ...
                                <tr>
                                    <td data-title="Product Name">
                                        ...
                                        <span>{{ $symbol }}{{{$invoice_info->insurance_amount}}} {{ strtoupper($currency_code) }}</span>
                                    </td>
                                    <td data-title="Unit Price"></td>
                                    <td data-title="Total"></td>
                                    <td data-title="Total"></td>
