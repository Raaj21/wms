...
class SiteManagement extends Model
{
    ...
    public static function saveEmailSettings($email_data)
    {
        ...
        if (!empty($email_data)) {
            ...
            foreach ($email_data as $key => $email) {
                ...
                Helper::changeEnv(
                    [
                        'MAIL_FROM_NAME' => !empty($email['from_email_id']) ? $email['from_email_id'] : '',
                        'MAIL_FROM_ADDRESS' => !empty($email['from_email']) ? $email['from_email'] : '',
                    ]
                );
    ...
    public static function saveInnerPageSettings($inner_page_data)
    {
        ...
        if (!empty($inner_page_data)) {
            ...
            foreach ($inner_page_data as $key => $inner_page) {
                ...
                $inner_page_data_array[$key]['show_f_banner'] = !empty($inner_page['show_f_banner']) ? $inner_page['show_f_banner'] : '';
                $inner_page_data_array[$key]['add_f_navbar'] = $inner_page['add_f_navbar'];
                $inner_page_data_array[$key]['add_emp_navbar'] = $inner_page['add_emp_navbar'];
                $inner_page_data_array[$key]['add_job_navbar'] = $inner_page['add_job_navbar'];
                ...
                $inner_page_data_array[$key]['employer_header_styling'] = !empty($inner_page['employer_header_styling']) ? $inner_page['employer_header_styling'] : '';
                $inner_page_data_array[$key]['e_menu_text_color'] = !empty($inner_page['e_menu_text_color']) ? $inner_page['e_menu_text_color'] : '';
                $inner_page_data_array[$key]['e_menu_color'] = !empty($inner_page['e_menu_color']) ? $inner_page['e_menu_color'] : '';
                $inner_page_data_array[$key]['e_hover_color'] = !empty($inner_page['e_hover_color']) ? $inner_page['e_hover_color'] : '';
                $inner_page_data_array[$key]['emp_header_style'] = !empty($inner_page['emp_header_style']) ? $inner_page['emp_header_style'] : '';;
                $inner_page_data_array[$key]['job_header_styling'] = !empty($inner_page['job_header_styling']) ? $inner_page['job_header_styling'] : '';
                $inner_page_data_array[$key]['job_menu_text_color'] = !empty($inner_page['job_menu_text_color']) ? $inner_page['job_menu_text_color'] : '';
                $inner_page_data_array[$key]['job_menu_color'] = !empty($inner_page['job_menu_color']) ? $inner_page['job_menu_color'] : '';
                $inner_page_data_array[$key]['job_hover_color'] = !empty($inner_page['job_hover_color']) ? $inner_page['job_hover_color'] : '';
                $inner_page_data_array[$key]['job_header_style'] = !empty($inner_page['job_header_style']) ? $inner_page['job_header_style'] : '';;
                $inner_page_data_array[$key]['service_header_styling'] = !empty($inner_page['service_header_styling']) ? $inner_page['service_header_styling'] : '';
                $inner_page_data_array[$key]['service_menu_text_color'] = !empty($inner_page['service_menu_text_color']) ? $inner_page['service_menu_text_color'] : '';
                $inner_page_data_array[$key]['service_menu_color'] = !empty($inner_page['service_menu_color']) ? $inner_page['service_menu_color'] : '';
                $inner_page_data_array[$key]['service_hover_color'] = !empty($inner_page['service_hover_color']) ? $inner_page['service_hover_color'] : '';
                $inner_page_data_array[$key]['service_header_style'] = !empty($inner_page['service_header_style']) ? $inner_page['service_header_style'] : '';;
                $inner_page_data_array[$key]['article_header_styling'] = !empty($inner_page['article_header_styling']) ? $inner_page['article_header_styling'] : '';
                $inner_page_data_array[$key]['article_menu_text_color'] = !empty($inner_page['article_menu_text_color']) ? $inner_page['article_menu_text_color'] : '';
                $inner_page_data_array[$key]['article_menu_color'] = !empty($inner_page['article_menu_color']) ? $inner_page['article_menu_color'] : '';
                $inner_page_data_array[$key]['article_hover_color'] = !empty($inner_page['article_hover_color']) ? $inner_page['article_hover_color'] : '';
                $inner_page_data_array[$key]['article_header_style'] = !empty($inner_page['article_header_style']) ? $inner_page['article_header_style'] : '';;
                ...
                $inner_page_data_array[$key]['show_emp_banner'] = !empty($inner_page['show_emp_banner']) ? $inner_page['show_emp_banner'] : '';
                ...
                $inner_page_data_array[$key]['show_job_banner'] = !empty($inner_page['show_job_banner']) ? $inner_page['show_job_banner'] : '';
                ...
                $inner_page_data_array[$key]['show_service_banner'] = !empty($inner_page['show_service_banner']) ? $inner_page['show_service_banner'] : '';
                ...
                $inner_page_data_array[$key]['show_article_banner'] = !empty($inner_page['show_article_banner']) ? $inner_page['show_article_banner'] : '';
                ...
                if (!empty($inner_page['f_logo'])) {
                    if (file_exists($old_path . '/' . $inner_page['f_logo'])) {
                        if (!file_exists($new_path)) {
                            File::makeDirectory($new_path, 0755, true, true);
                        }
                        $filename = time() . '-' . $inner_page['f_logo'];
                        rename($old_path . '/' . $inner_page['f_logo'], $new_path . '/' . $filename);
                        $inner_page_data_array[$key]['f_logo'] = $filename;
                    } else {
                        $inner_page_data_array[$key]['f_logo'] = $inner_page['f_logo'];
                    }
                }
                ...
                if (!empty($inner_page['e_logo'])) {
                    if (file_exists($old_path . '/' . $inner_page['e_logo'])) {
                        if (!file_exists($new_path)) {
                            File::makeDirectory($new_path, 0755, true, true);
                        }
                        $filename = time() . '-' . $inner_page['e_logo'];
                        rename($old_path . '/' . $inner_page['e_logo'], $new_path . '/' . $filename);
                        $inner_page_data_array[$key]['e_logo'] = $filename;
                    } else {
                        $inner_page_data_array[$key]['e_logo'] = $inner_page['e_logo'];
                    }
                }
                ...
                if (!empty($inner_page['job_logo'])) {
                    if (file_exists($old_path . '/' . $inner_page['job_logo'])) {
                        if (!file_exists($new_path)) {
                            File::makeDirectory($new_path, 0755, true, true);
                        }
                        $filename = time() . '-' . $inner_page['job_logo'];
                        rename($old_path . '/' . $inner_page['job_logo'], $new_path . '/' . $filename);
                        $inner_page_data_array[$key]['job_logo'] = $filename;
                    } else {
                        $inner_page_data_array[$key]['job_logo'] = $inner_page['job_logo'];
                    }
                }
                ...
                if (!empty($inner_page['service_logo'])) {
                    if (file_exists($old_path . '/' . $inner_page['service_logo'])) {
                        if (!file_exists($new_path)) {
                            File::makeDirectory($new_path, 0755, true, true);
                        }
                        $filename = time() . '-' . $inner_page['service_logo'];
                        rename($old_path . '/' . $inner_page['service_logo'], $new_path . '/' . $filename);
                        $inner_page_data_array[$key]['service_logo'] = $filename;
                    } else {
                        $inner_page_data_array[$key]['service_logo'] = $inner_page['service_logo'];
                    }
                }
                ...
                if (!empty($inner_page['article_logo'])) {
                    if (file_exists($old_path . '/' . $inner_page['article_logo'])) {
                        if (!file_exists($new_path)) {
                            File::makeDirectory($new_path, 0755, true, true);
                        }
                        $filename = time() . '-' . $inner_page['article_logo'];
                        rename($old_path . '/' . $inner_page['article_logo'], $new_path . '/' . $filename);
                        $inner_page_data_array[$key]['article_logo'] = $filename;
                    } else {
                        $inner_page_data_array[$key]['article_logo'] = $inner_page['article_logo'];
                    }
                }
            }
        ...
        if (!empty($settings)) {
            ...
            foreach ($settings as $key => $setting) {
                ...
                if (!empty($setting['header_style'])) {
                    ...
                    $settings_array[$key]['header_style'] = 'style1';
                }
    ...
    public function saveStripeSettings($request)
    {
        ...
        $old_path = Helper::PublicPath() . '/uploads/settings/temp';
        $new_path = Helper::PublicPath() . '/uploads/settings/payment';
        $filename = $request['stripe_img'];
        if (file_exists($old_path . '/' . $request['stripe_img'])) {
            if (!file_exists($new_path)) {
                File::makeDirectory($new_path, 0755, true, true);
            }
            $filename = time() . '-' . $request['stripe_img'];
            rename($old_path . '/' . $request['stripe_img'], $new_path . '/' . $filename);
            $request['stripe_img'] = $filename;
        }
        $stripe_image = $request['stripe_img'];
        $payment_settings = array();
        ...
        $payment_settings[0]['stripe_img'] = !empty($stripe_image) ? $stripe_image : '';
    ...
    public static function saveMenuSettings($menu_settings)
    {
        ...
        if (!empty($menu_settings)) {
            ...
            $menu_settings_array['menu_hover_color'] = $menu_settings['menu_hover_color'];
            Meta::where('meta_key', 'page_order')->delete();
            if (!empty($menu_settings['pages'])) {
                foreach ($menu_settings['pages'] as $key => $value) {
                    if ($value['type'] == 'innerPages') {
                        ...
                        $meta = new Meta();
                        $meta->meta_key = 'page_order';
                        $meta->meta_value = $value['order'];
                        $page->meta()->save($meta);
                    }
                }
            }
            ...
            DB::table('site_managements')->insert(
                [
                    'meta_key' => 'menu_settings', 'meta_value' => serialize($menu_settings_array),
                    "created_at" => Carbon::now(), "updated_at" => Carbon::now()
                ]
            );
            return 'success';
