                ...
                <div class="row justify-content-md-center">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 push-lg-2" id="jobs">
                        ...
                        <div class="wt-proposalamount-holder">
                            ...
                            {!! Form::open(['url' => url('proposal/submit-proposal') . (isset($invited) && !empty($invited) ? '?invited=' . $invited : ''), 'class' =>'wt-haslayout', 'id' => 'send-propsal',  '@submit.prevent'=>'submitJobProposal('.$job->id.', '.Auth::user()->id.')']) !!}
                                ...
                                <div class="wt-formtheme wt-formproposal">
                                    <fieldset class="wt-completion_time">
                                        <div class="form-group">
                                            <span>( <i>{{ trans('lang.unit_days') }}</i> )</span>
                                            {!! Form::input('number', 'completion_time', null, ['class' => 'form-control', 'placeholder' => trans('lang.ph_job_completion_time'), 'v-model'=>'proposal.completion_time', ]) !!}
