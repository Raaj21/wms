...
export default{
    ...
    props: ['widget_title', 'server_error_message', 'server_errors', 'ph_award_title', 'weekdays', 'months', 'ph_select_award_date'],
        data(){
            return {
                ...
                award: {
                    ...
                    date:this.ph_select_award_date,
                    count: 0,
                    img_id: 'award_img',
                    ...
                    acceptedFiles: ".pdf",
                    option:{
                        url: APP_URL+'/writer/upload-temp-image',
                        maxFilesize: 2, // MB
                        maxFiles: 1,
        ...
        methods: {
            getAwards(){
                let self = this;
                axios.get(APP_URL + '/writer/get-writer-awards')
