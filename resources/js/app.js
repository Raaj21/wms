...
Vue.component('conversation', require('./components/admin/ConversationComponent.vue').default);
    ...
    const freelancerProfile = new Vue({
        ...
        methods: {
            ...
            submitProfileSettings: function () {
                ...
                axios.post(APP_URL + '/writer/profile-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.next();
                        } else if (response.data.type == 'error') {
            ...
            submitFreelancerProfile: function () {
                ...
                axios.post(APP_URL + '/writer/store-profile-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
            ...
            submitExperienceEduction: function () {
                ...
                axios.post(APP_URL + '/writer/store-experience-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
            ...
            submitPaymentSettings: function () {
                ...
                axios.post(APP_URL + '/writer/store-payment-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.processing);
                            setTimeout(function () {
                                window.location.replace(APP_URL + '/writer/dashboard');
                            }, 4000);
                        } else {
                            self.showError(response.data.message);
                        }
            ...
            submitAwardsProjects: function () {
                ...
                axios.post(APP_URL + '/writer/store-project-award-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.message);
                        } else if (response.data.type == 'error') {
            ...
            submitEmployerProfile: function () {
                ...
                axios.post(APP_URL + '/client/store-profile-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.process);
                            setTimeout(function () {
                                window.location.replace(APP_URL + '/client/dashboard');
                            }, 4000);
                        } else if (response.data.type == 'error') {
                            self.showError(response.data.message);
                        }
            ...
            getWishlist: function () {
                ...
                axios.post(APP_URL + '/profile/get-wishlist', {
                    ...
                    .then(function (response) {
                        if (response.data.user_type == 'writer') {
                ...
                axios.post(APP_URL + '/job/post-job', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            ...
                            setTimeout(function () {
                                window.location.replace(APP_URL + '/client/dashboard/manage-jobs');
                            }, 4000);
                        } else {
                            self.loading = false;
                            self.showError(response.data.message);
    ...
    const jobVue = new Vue({
        ...
        methods: {
                ...
                axios.post(APP_URL + '/proposal/submit-proposal', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            ...
                            setTimeout(function () {
                                window.location.replace(APP_URL + '/writer/proposals');
                            }, 1050);
                        } else {
                            self.loading = false;
                            self.showError(response.data.message);
            ...
            submitDispute: function (id) {
                ...
                var self = this;
                axios.post(APP_URL + '/writer/store-dispute', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.loading = false;
                            var message = response.data.message;
    ...
    const vservices = new Vue({
        ...
        methods: {
                        ...
                        if (response.data.type == 'success') {
                            ...
                            document.addEventListener('iziToast-closing', function (data) {
                                if (data.detail.id == 'info_notify') {
                                    self.showCompleted(response.data.message);
                                    window.location.replace(APP_URL + '/writer/services/posted');
                                }
                            });
                        } else {
                            self.loading = false;
            ...
            getSettings: function () {
                ...
                var segment_array = segment_str.split('/');
                var id = segment_array[segment_array.length - 1];
                if (segment_str == '/writer/dashboard/edit-service/' + id) {
                        ...
                        if (mode == 'false') {
                            ...
                            .catch(function (error) {
                                if (error.response.status == 503) {
                                    self.showError(Vue.prototype.trans('lang.buy_service_warning'));
                                }
                            });
                        } else {
                                ...
                                .then(function (response) {
                                    if (response.data.type == 'success') {
                                        ...
                                        document.addEventListener('iziToast-closing', function (data) {
                                            if (data.detail.id == 'info_notify') {
                                                self.showCompleted(response.data.message);
                                                window.location.replace(APP_URL + '/client/services/cancelled');
                                            }
                                        });
                                    } else if (response.data.type == 'error') {
                                        self.showError(response.data.message);
                ...
                axios.post(APP_URL + '/user/submit-review', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            ...
                            setTimeout(function () {
                                self.$refs.myModalRef.hide()
                                window.location.replace(APP_URL + '/client/services/completed');
                            }, 1000);
                        } else {
                            self.loading = false;
                            self.showError(response.data.message);
