                                ...
                                <div class="wt-proposalholder">
                                    ...
                                    <div class="wt-btnarea">
                                        ...
                                        @if(auth()->check() && $job->user_id == auth()->user()->id)
                                            <a href="{{ url('search-results?type=writer&invite=' . $job->slug) }}" class="wt-btn">{{{ trans('lang.invite_writer') }}}</a>
                                        @elseif($user_role == 'Writer')
                                        <a href="javascript:void(0);" @click.prevent="check_auth('{{{ url('job/proposal/'.$job->slug) }}}')" class="wt-btn">{{{ ($user_role == 'Writer') ?trans('lang.apply_job') : trans('lang.invite_writer')}}} </a>
